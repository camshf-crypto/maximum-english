...
export const examCards: ProgramCard[] = [
  {
    ...
    desc: '영어 면접과 자기주도학습 역량이 핵심. 실전 면접과 자소서를 집중 훈련합니다.',
    points: ['영어 면접 유형별 훈련', '자소서 스토리 설계', '학생부 연계 첨삭'],
  },
  {
  ...
  },
  {
    ...
    desc: '탐구 면접과 영어 발표 역량을 함께. 논리적으로 설명하는 힘을 기릅니다.',
    points: ['영어 발표 · 설명 훈련', '탐구 면접 대비', '자기소개 영문 작성'],
  },
]
...
export const homeGrades: ProgramCard[] = [
  ...
  },
  {
    ...
    points: ['유형별 영어 면접 시뮬레이션', '자소서·학생부 첨삭', '지망교별 합격 전략'],
    to: '/exam',
  },
]
